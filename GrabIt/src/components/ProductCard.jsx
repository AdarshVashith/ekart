  ...
  return product && (
    <div onClick={() => navigate(`/product/${product.category.toLowerCase()}/${product._id}`)} className='border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56'>
        <div className='group cursor-pointer flex items-center justify-center px-2 relative'>
            ...
            />
            <div 
                className='hidden group-hover:scale-105 transition max-w-26 md:max-w-36 w-32 h-32 bg-gray-200 items-center justify-center text-gray-600 font-bold text-xl rounded'
                style={{display: 'none'}}
            >
