    ...
    <div className='mt-16'>
        ...
        <div className='my-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-7 gap-4 items-center justify-center'>
            {categories.map((category, index) => (
                <div onClick={() => {
                        setSearchQuery(category.path.toLowerCase());
                        navigate(`/products`);
                        scrollTo(0, 0);
                    }} className={`group cursor-pointer py-5 px-3 rounded-lg gap-2 flex flex-col items-center justify-center`} style={{backgroundColor: category.bgColor}} key={index}>
