...
const Cart = () => {
  const {products, navigate, cartItems, totalCartItems, totalCartAmount, updateCartItem, user, setShowUserLogin, api, token} = useContext(AppContext);
    ...
    {products.length>0 && cartItems ? (
      <div className="flex flex-col md:flex-row py-16 max-w-6xl w-full px-6 mx-auto">
          ...
          <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
              ...
              {user ? paymentOption==="COD" ? <button onClick={async () => {
                const orderData = {
                  ...
                  amount: Math.floor(totalCartAmount()*102)/100,
